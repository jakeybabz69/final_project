...
```
#### Summary
In summary, I have used publicly available data to create a an interactive map of mild to moderate depression or anxiety prevalence across the UK.
