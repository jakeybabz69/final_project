...
Below is an overview of the data from the documents I plan to use.
...
#extracts only the data from rows 12 to 28 ie the rows about depression across the years and reassigns t
